...
import xhr from "xhr";
import { List, Card, Input, Typography } from 'antd';
const { Text } = Typography;

/**
 * Geocoder component: connects to Mapbox.com Geocoding API
 * and provides an autocompleting interface for finding locations.
 * https://github.com/kmwhelan93/react-geocoder-autocomplete/blob/master/src/main.js
 * <Geocoder
  ...
  />
  * Here is the official repo, but our code is not based off this: https://github.com/mapbox/react-geocoder
 */
/*
    New Defaults:
    bbox =  "-17.531,-34.836,51.416,37.346" // Africa
*/
// minLon,minLat,maxLon,maxLat
const africaBoundingBox = "-17.531,-34.836,51.416,37.346";
...
class Geocoder extends Component {
  ...
  render() {
    ...
    var input = React.createElement(Input.Search, {
      ref: "input",
          ...
          <Card>
            {React.createElement(
                ...
                this.state.results.map(function(result, i) {
                  ...
                  const className = _this.props.resultClass + " " +
                  (i === _this.state.focus
                      ? _this.props.resultFocusClass
                      : "");
                  const _onClick = (e) => _this.clickOption(result, i, e);
                  const _onFocus = (e) => {
                    // focus on the input after click to maintain key traversal
                    ReactDOM.findDOMNode(_this.refs.input).focus();
                    _this.clickOption(result, i, e);
                  }
                  const key = result.id;
                  ...
                  return (
                    <List.Item className={className} style={listItemStyle} {...commonProps}>
                      <Text ellipsis style={listTextStyle} {...commonProps}>
                        <a {...commonProps}>
                          {result.place_name}
                        </a>
                      </Text>
